  ...
  events: [
    {
      ...
      description: "Knight4Life Summer Camp — Where Every Move Matters. Five days. All skill levels. One unforgettable week. Knight4Life Summer Camp is a student-led summer program where beginners and experienced players alike learn, compete, and grow together. Each day has its own theme — from tactical puzzles and team challenges to a real Swiss-format tournament on Thursday and a Grand Finale celebration on Friday. Campers are grouped by skill level from day one, so everyone is challenged, supported, and never left behind. From a workshop with our guest titled player to supportive volunteers from state-placing high school teams, each camper will have appropriate guidance to ensure they improve as a player and person from this camp. Beyond the chess, campers earn team points, solve daily puzzles, and walk away with personalized achievement certificates and camp swag. It's competitive, creative, and a whole lot of fun. Whether your child is just learning how the pieces move or has been playing for years, there's a place for them here. Spots are limited — register today.",
      schedule: [
